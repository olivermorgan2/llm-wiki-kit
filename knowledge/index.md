...
| [`design/adr/`](../design/adr/) | ADR index — ADR-001–005 **accepted** (2026-07-01); ADR-006/007/009 **accepted** (2026-07-03, Phase 2 — transaction model, profile system, install ownership; Codex `READY` 5/5, under the autonomous-phase mandate pending Oliver's async ratification); ADR-008/010/011/012 candidates still surfaced by the build-out plan. |
